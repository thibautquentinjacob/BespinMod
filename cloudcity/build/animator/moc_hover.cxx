...
void Animator::Hover::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        Hover *_t = static_cast<Hover *>(_o);
        switch (_id) {
...
const QMetaObjectExtraData Animator::Hover::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject Animator::Hover::staticMetaObject = {
    { &Basic::staticMetaObject, qt_meta_stringdata_Animator__Hover,
      qt_meta_data_Animator__Hover, &staticMetaObjectExtraData }
};
